...
exports.groupBot = (sender) => {
    return `
Link Group Chika Fenst : minta ke owner agar bisa jadi murid bot 
Link Group Chika Fenst V2 : minta ke owner sayang :)
